...
CID_VERSION_TAG_NAME = '__cid_version_tag__'
...
class Dashboard(CidQsResource):
    ...
    def deployed_cid_version(self):
        ...
        tag_version = (self.qs.get_tags(self.arn) or {}).get(CID_TAG)
        ...
        if tag_version:
            ...
            if self._cid_version:
                ...
                self.qs.set_tags(self.arn, **{CID_VERSION_TAG_NAME: self._cid_version})
        return self._cid_version
