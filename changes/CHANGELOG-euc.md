...
The EUC dashboard offers a centralized solution for monitoring and optimizing Amazon WorkSpaces and WorkSpaces Applications environments by combining Cost and Usage Report (CUR) data with API-driven insights.
...
2. WorkSpaces Applications Analytics: Detailed insights into fleet utilization, image builder usage, and weekend usage patterns to optimize resource allocation.
...
## EUC Dashboard - v1.2.0
* Fixed filters in various graphs
* Renamed AppStream 2.0 references to WorkSpaces Applications
* Updated WorkSpaces Applications adding more insights to Fleets